...
[![NuGet](https://img.shields.io/nuget/v/Rag.NET.DataProviders.Confluence.svg?logo=nuget&label=Rag.NET.DataProviders.Confluence)](https://www.nuget.org/packages/Rag.NET.DataProviders.Confluence)
[![Downloads](https://img.shields.io/nuget/dt/Rag.NET.DataProviders.Confluence.svg?logo=nuget&label=downloads)](https://www.nuget.org/packages/Rag.NET.DataProviders.Confluence)
