...
[![NuGet](https://img.shields.io/nuget/v/Rag.NET.VectorStores.Redis.svg?logo=nuget&label=Rag.NET.VectorStores.Redis)](https://www.nuget.org/packages/Rag.NET.VectorStores.Redis)
[![Downloads](https://img.shields.io/nuget/dt/Rag.NET.VectorStores.Redis.svg?logo=nuget&label=downloads)](https://www.nuget.org/packages/Rag.NET.VectorStores.Redis)
