...
[![NuGet](https://img.shields.io/nuget/v/Rag.NET.Mcp.Tool.svg?logo=nuget&label=Rag.NET.Mcp.Tool)](https://www.nuget.org/packages/Rag.NET.Mcp.Tool)
[![Downloads](https://img.shields.io/nuget/dt/Rag.NET.Mcp.Tool.svg?logo=nuget&label=downloads)](https://www.nuget.org/packages/Rag.NET.Mcp.Tool)
