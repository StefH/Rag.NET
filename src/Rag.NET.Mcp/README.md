...
[![NuGet](https://img.shields.io/nuget/v/Rag.NET.Mcp.svg?logo=nuget&label=Rag.NET.Mcp)](https://www.nuget.org/packages/Rag.NET.Mcp)
[![Downloads](https://img.shields.io/nuget/dt/Rag.NET.Mcp.svg?logo=nuget&label=downloads)](https://www.nuget.org/packages/Rag.NET.Mcp)
