...
[![NuGet](https://img.shields.io/nuget/v/Rag.NET.Cli.svg?logo=nuget&label=Rag.NET.Cli)](https://www.nuget.org/packages/Rag.NET.Cli)
[![Downloads](https://img.shields.io/nuget/dt/Rag.NET.Cli.svg?logo=nuget&label=downloads)](https://www.nuget.org/packages/Rag.NET.Cli)
