...
[![NuGet](https://img.shields.io/nuget/v/Rag.NET.Embeddings.Onnx.svg?logo=nuget&label=Rag.NET.Embeddings.Onnx)](https://www.nuget.org/packages/Rag.NET.Embeddings.Onnx)
[![Downloads](https://img.shields.io/nuget/dt/Rag.NET.Embeddings.Onnx.svg?logo=nuget&label=downloads)](https://www.nuget.org/packages/Rag.NET.Embeddings.Onnx)
